" Vim gitgub256_custom colorscheme
...
let g:colors_name="github256_custom"
...
"	call <SID>X("DiffDelete", "2E2E2E", "FFA296", "")
 ...
 highlight DiffRemoved guifg=#2E2E2E guibg=#FFA296
  ...
  call <SID>X("Normal", "000000", "f4f7fe", "")
	...
	" call <SID>X("FoldColumn" , "666666" , "eaeaea" , "")
	call <SID>X("Folded"     , "666666" , "eaeaea" , "")
	call <SID>X("FoldColumn" , "666666" , "eaeaea" , "")
...
" hi Visual         guifg=NONE  guibg=#403D3D
  ...
  " candidates
  call <SID>X("Pmenu", "666666", "eaeaea", "")
  " selection
	call <SID>X("PmenuSel", "eaeaea", "666666", "")
  " scrollbar_back
	call <SID>X("PmenuSbar", "888888", "cccccc", "")
  " scrollbar
	call <SID>X("PmenuThumb", "666666", "666666", "")

  " call <SID>X("PmenuSbar", "eaeaea", "666666", "")
  " call <SID>X("PmenuThumb", "eaeaea", "666666", "")
  " call <SID>X("PmenuThumb", "", "ffff86", "")
