...
vnoremap <silent> <M-H> :wincmd H<CR>
vnoremap <silent> <M-L> :wincmd L<CR>
vnoremap <silent> <M-K> :wincmd K<CR>
vnoremap <silent> <M-J> :wincmd J<CR>
...
xnoremap <silent> <M-r>      :QuickRun<CR>
...
augroup my_config "{{{
  ...
  autocmd FileType coffee vnoremap  <buffer> <silent> <M-r> :call QuickRunScrollEnd()<CR>
  ...
  autocmd FileType coffee vnoremap  <buffer> <silent> <M-p> :call CoffeeCompile()<CR>
