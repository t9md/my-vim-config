...
function! g:fthook.unite() "{{{
  ...
  if b:unite.buffer_name =~# 'file_\d'
    nnoremap <silent> <buffer> <M-[>      :call g:unite_file_resume('previous')<CR>
    nnoremap <silent> <buffer> <M-]>      :call g:unite_file_resume('next')<CR>
    inoremap <silent> <buffer> <M-[> <C-o>:call g:unite_file_resume('previous')<CR>
    inoremap <silent> <buffer> <M-]> <C-o>:call g:unite_file_resume('next')<CR>
    " inoremap <silent> <buffer> <C-z> :call g:unite_file.resume()<CR>
  endif
  if b:unite.buffer_name =~# 'file_rec_\d'
    nnoremap <silent> <buffer> <M-[>      :call g:unite_file_rec_resume('previous')<CR>
    nnoremap <silent> <buffer> <M-]>      :call g:unite_file_rec_resume('next')<CR>
    inoremap <silent> <buffer> <M-[> <C-o>:call g:unite_file_rec_resume('previous')<CR>
    inoremap <silent> <buffer> <M-]> <C-o>:call g:unite_file_rec_resume('next')<CR>
    " inoremap <silent> <buffer> <C-z> :call g:unite_file.resume()<CR>
  endif
